    ...
    >
      <div className="bg-white shadow-lg rounded-lg p-8 max-w-md w-full ml-16">
        <div className="text-center mb-6">
          <h1 className="text-xl font-bold mb-8">Capital Enterprises</h1>
          <h2 className="text-4xl font-bold mb-2 text-slate-800">Welcome Back</h2>
          <p className="text-xs text-slate-400 uppercase" >One-stop top quality electricals</p>
        </div>
        <form>
          <div className="mb-4">
